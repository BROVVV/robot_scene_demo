...
class MotionActionServer : public rclcpp::Node {
 ...
 private:
  struct Parameters {
    ...
    double post_timed_zero_velocity_hold_sec{0.8};
    ...
    double timed_min_distance_ratio{0.30};
    double timed_min_distance_m{0.03};
  ...
  struct ExecutionState {
    ...
    bool post_timed_zero_velocity_hold_completed{false};
